...
public class JhMicroApp {

    private static final Logger log = LoggerFactory.getLogger(JhMicroApp.class);

    private final Environment env;

    public JhMicroApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhMicroApp.class);
